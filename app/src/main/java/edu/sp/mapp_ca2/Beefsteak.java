...
public class Beefsteak extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beefsteak);
        queue = Volley.newRequestQueue(this);
        button = (Button) findViewById(R.id.beefaddtocart);
        named = (TextView) findViewById(R.id.titlebeef);
        priced = (TextView) findViewById(R.id.beefpricing);
        quantities = (EditText) findViewById(R.id.beefquantityedit);
